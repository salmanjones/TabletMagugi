...
export class PayTypeList extends PureComponent {
    ...
    renderDash = () => {
        return <Dash style={multiplyPayStyle.bodyLeftItemSplit} dashColor="#cbcbcb" dashLength={4} dashGap={4}
                     dashThickness={1}/>;
    };
        ...
        return (
            <TouchableOpacity
                ...
                <View style={disable == true
                    ...
                    : (selected ? multiplyPayStyle.bodyLeftItemActive : multiplyPayStyle.bodyLeftItem)
                }>
